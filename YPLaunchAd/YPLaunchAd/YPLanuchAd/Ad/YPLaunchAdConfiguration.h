...
#pragma mark - 公共属性
@interface YPLaunchAdConfiguration : NSObject
...
/** 点击打开页面地址(请使用openModel,点击事件代理方法请对应使用YPLaunchAd:clickAndOpenModel:clickPoint:) */
@property(nonatomic,copy)NSString *openURLString YPLaunchAdDeprecated("请使用openModel,点击事件代理方法请对应使用YPLaunchAd:clickAndOpenModel:clickPoint:");
...
#pragma mark - 图片广告相关
@interface YPLaunchImageAdConfiguration : YPLaunchAdConfiguration
...
/** 缓存机制(default YPLaunchImageDefault) */
@property(nonatomic,assign)YPLaunchAdImageOptions imageOption;
...
#pragma mark - 视频广告相关
@interface YPLaunchVideoAdConfiguration : YPLaunchAdConfiguration

/** video本地名或网络链接URL string */
@property(nonatomic,copy)NSString *videoNameOrURLString;

/** 视频缩放模式(default MPMovieScalingModeAspectFill) */
@property(nonatomic,assign)MPMovieScalingMode scalingMode YPLaunchAdDeprecated("请使用videoGravity");
